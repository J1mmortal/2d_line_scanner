...
if __name__ == "__main__":
    ...
    # means = np.linspace(-0.025, 0.025, 5)
    ...
    dt.plot_monte_carlo_results(rmse, noise_std=delay_std)
    dt.plot_monte_carlo_results(fitness, noise_std=delay_std)
    dt.plot_monte_carlo_results(fn, noise_std=delay_std)
    dt.plot_monte_carlo_results(fp, noise_std=delay_std)
